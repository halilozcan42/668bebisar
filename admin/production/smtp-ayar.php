                  ...
                  <div class="x_content">
                    ...
                    <form action="../connect/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="first-name"  name="ayar_smtpuser" value="<?php echo $ayarcek['ayar_smtpuser'] ?> " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" name="smtpayarkaydet" class="btn btn-success">Update</button>
                        </div>
                      </div>
